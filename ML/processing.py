...
class document_processing:
    ...
    def extract_resume(self):
        ...
        # extract info from the resume using pyresparser
    ...
    def find_match(self, source, match):
        ...
        if match_skills == 0:
            ...
            score = round(float((match_skills / max_val)*100),2)
    ...
    def resume_cosine_score(self, text):
        ...
        match_percentage = round(float((cosine_similarity(count_matrix)[0][1])*200),2)
    ...
    def skills_match(self):
        ...
        details.loc[0, 'document_similarity'] = float(doc_sim)
